local Fluent = loadstring(game:HttpGet("github.com/dawid-scripts/Fluent/releases/latest/download/main.lua"))()
...
spawn(function()
    ...
    local FarmMode = Tabs.Main:AddDropdown("FarmMode", {
        Title = "Select FarmMode",
        Values = {'Level','Bone','Cake Prince'},
        Multi = false,
        Default = 1,
    })
    FarmMode:SetValue('Level')
